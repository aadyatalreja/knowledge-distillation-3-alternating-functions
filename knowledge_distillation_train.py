...
def train(teacher, student, epoch, train_loader, soft_target_loss_weight, ce_loss_weight, T):
    ...
    for inputs, labels in train_loader:
        ...
        if epoch % 3 == 0:
            ...
            loss = ce_loss_weight * label_loss
...
if __name__ == '__main__':
    ...
    # Set optimizer with a constant learning rate
    ...
    for epoch in range(1, settings.EPOCH + 1):
        # Comment this out to keep LR constant
        # if epoch > args.warm:
        ...
        train(teacher, kd_student, epoch, cifar100_training_loader, soft_target_loss_weight=0.001, ce_loss_weight=1, T=2)
